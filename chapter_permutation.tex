...
\indent When the quiver is $A_n$ straight orientation we can make much stronger claims. In fact there is a canonical permutation of any mutation sequence. The formula of the associated permutation of reddening sequences and loop sequences is given as the following.\\
\begin{theorem}
