\chapter{Tame hereditary algebras are green sequence-finite}\label{C2}
...
\end{proof}
\indent Now I can prove \ref{def:C3L3}.
\begin{proof}
...
\end{enumerate}
\end{definition}
\indent Hence I can rephrase Theorem \ref{C3T2} as the following:
\begin{theorem}
