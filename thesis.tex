...
\graduationyear{2019}
\graduationmonth{May}
\thesisabstract{Maximal green sequences were invented by Bernhard Keller and have a lot of applications in math and physics. In this dissertation I will discuss four separate topics related to maximal green sequences. First of all I will discuss the problem of associated permutations of mutation sequences and establish a formula for the associated permutation in the case of $A_n$ straight orientation. Secondly I will introduce the concept of $m$-maximal green sequences and discuss the problem of $m$-maximal green sequence-finiteness of tame hereditary algebras. Then I will introduce two alternative definitions of green mutation sequences and show that they are both equivalent to the known ones. Finally I will discuss the problem of maximal green sequences in quivers with multiple edges and show that in the acyclic case any maximal green sequence of such quivers must also be maximal green sequences of their multiple edges-free versions.}
\begin{document}
\thesisfront
%\input{chapter_intro}
